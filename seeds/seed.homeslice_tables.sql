BEGIN;
  ...
  INSERT INTO restaurants
    (name, email, password, phone, street_address, city, state, zipcode)
  VALUES
  ...
  INSERT INTO customers
    (first_name, last_name, email, phone, street_address, city, state, zipcode, notes)
  VALUES
    ('Mario', 'Mario', 'mario@mariobrosplumbing.net', '111-111-1111', '987 Plumber Blvd. Apt. 2', 'Nintendoland', 'CA', '99999', '');

  INSERT INTO orders
    (restaurant_id, pizza_id, customer_id, order_status, order_total)
  VALUES
    (1, 1, 1, 'Ordered', 15.00);
